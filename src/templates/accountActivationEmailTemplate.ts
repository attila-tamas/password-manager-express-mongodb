...
export default function AccountActivationEmailTemplate(token: string, tokenMaxAgeSeconds: number) {
	...
	return `
		<div style="width: 100%; background-color: #F8F9FC; display: flex; flex-direction: column; text-align: center;">
			<div style="max-width: 34.0625em; margin: 4% auto; padding: 2% 4%; padding-top: 0; background-color: #FFFFFF; border-radius: 0.5em; border: 0.0625em solid #EDEEF1;">
				...
				<h1 style="padding: 0; margin: 0; font-size: 1.5em;">Account activation</h1>
				...
				<p style="font-size: 0.875em">
					You cannot use your account until it is activated. If you do not activate your account before the verification code expires, you will need to request a new code.
				</p>
			</div>
		</div>
	`;
